...
def plot_outputVDA(path_data, path_out='./results/'):
  ...
  plt.savefig('./results_store/cost_decr.png')
  ...
  plt.legend(loc="upper right",prop={'size': fsize})
  plt.show(block=False)
  plt.savefig('./results_store/constant_ref_values_decr.png')
  ...
  plt.show(block=False)
  plt.savefig('./results_store/gradient_vs_iterations_decr.png')
  ...
  plt.savefig('./results_store/RMSEs_vs_iterations_decr.png')
  ...
  plt.legend(prop={'size': fsize})
  plt.show(block=False)
  plt.savefig('./results_store/H_n_decr.png')
  ...
  plt.legend(prop={'size': fsize})
  plt.show(block=False)
  plt.savefig('./results_store/bathy_n_decr.png')
  ...
  plt.legend()
  # plt.show()
  plt.savefig('./results_store/profiles_decr.png')
