...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRessourcesAccess().getGroup(), "rule__Ressources__Group__0");
			builder.put(grammarAccess.getUseRessourcesAccess().getGroup(), "rule__UseRessources__Group__0");
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getUseressourcesAssignment_2(), "rule__WorkDefinition__UseressourcesAssignment_2");
			...
			builder.put(grammarAccess.getRessourcesAccess().getNameAssignment_1(), "rule__Ressources__NameAssignment_1");
			builder.put(grammarAccess.getRessourcesAccess().getNb_ressourcesAssignment_3(), "rule__Ressources__Nb_ressourcesAssignment_3");
			builder.put(grammarAccess.getRessourcesAccess().getUseressourcesAssignment_4(), "rule__Ressources__UseressourcesAssignment_4");
			builder.put(grammarAccess.getUseRessourcesAccess().getQuantityAssignment_1(), "rule__UseRessources__QuantityAssignment_1");
			builder.put(grammarAccess.getUseRessourcesAccess().getRessourcesAssignment_3(), "rule__UseRessources__RessourcesAssignment_3");
		}
	}
