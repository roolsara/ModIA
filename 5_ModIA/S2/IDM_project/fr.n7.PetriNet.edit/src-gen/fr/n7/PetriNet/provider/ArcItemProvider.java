...
/**
 * This is the item provider adapter for a {@link fr.n7.PetriNet.Arc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArcItemProvider extends PetriElementItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Arc_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Arc_type_feature", "_UI_Arc_type"),
						PetriNetPackage.Literals.ARC__TYPE, true, false, false,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Arc_source_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Arc_source_feature", "_UI_Arc_type"),
						PetriNetPackage.Literals.ARC__SOURCE, true, false, true, null, null, null));
	}
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Arc_target_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Arc_target_feature", "_UI_Arc_type"),
						PetriNetPackage.Literals.ARC__TARGET, true, false, true, null, null, null));
	}
