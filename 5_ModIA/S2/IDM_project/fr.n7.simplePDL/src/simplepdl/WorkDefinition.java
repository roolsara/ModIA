 ...
 *   <li>{@link simplepdl.WorkDefinition#getUseressource <em>Useressource</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Useressource</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.UseRessource}.
	 * It is bidirectional and its opposite is '{@link simplepdl.UseRessource#getWorkdefinition <em>Workdefinition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Useressource</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Useressource()
