...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	public EReference getWorkDefinition_Useressource() {
	 ...
	 * @generated
	 */
	public EAttribute getRessource_Nb_ressources() {
	 ...
	 * @generated
	 */
	public EReference getRessource_Useressource() {
	...
	public EAttribute getUseRessource_Quantity() {
		return (EAttribute)useRessourceEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getUseRessource_Workdefinition() {
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__USERESSOURCE);
		...
		createEAttribute(ressourceEClass, RESSOURCE__NB_RESSOURCES);
		createEAttribute(ressourceEClass, RESSOURCE__NAME);
		createEReference(ressourceEClass, RESSOURCE__USERESSOURCE);

		useRessourceEClass = createEClass(USE_RESSOURCE);
		createEReference(useRessourceEClass, USE_RESSOURCE__RESSOURCE);
		createEReference(useRessourceEClass, USE_RESSOURCE__WORKDEFINITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_Useressource(), this.getUseRessource(), this.getUseRessource_Workdefinition(), "useressource", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGuidance_Text(), ecorePackage.getEString(), "text", "", 1, 1, Guidance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(ressourceEClass, Ressource.class, "Ressource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRessource_Nb_ressources(), ecorePackage.getEInt(), "nb_ressources", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessource_Useressource(), this.getUseRessource(), this.getUseRessource_Ressource(), "useressource", null, 0, -1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(useRessourceEClass, UseRessource.class, "UseRessource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUseRessource_Ressource(), this.getRessource(), this.getRessource_Useressource(), "ressource", null, 1, 1, UseRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUseRessource_Workdefinition(), this.getWorkDefinition(), this.getWorkDefinition_Useressource(), "workdefinition", null, 1, 1, UseRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
