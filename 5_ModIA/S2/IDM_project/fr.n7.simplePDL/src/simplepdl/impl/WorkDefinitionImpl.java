 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getUseressource <em>Useressource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getUseressource() <em>Useressource</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getUseressource()
	 * @generated
	...
	public EList<UseRessource> getUseressource() {
		if (useressource == null) {
			useressource = new EObjectContainmentWithInverseEList<UseRessource>(UseRessource.class, this, SimplepdlPackage.WORK_DEFINITION__USERESSOURCE, SimplepdlPackage.USE_RESSOURCE__WORKDEFINITION);
		}
		return useressource;
	}
