...
public class RessourceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNb_ressourcesPropertyDescriptor(object);
			addNamePropertyDescriptor(object);
			addUseressourcePropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addNb_ressourcesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_nb_ressources_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_nb_ressources_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__NB_RESSOURCES,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Useressource feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUseressourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_useressource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_useressource_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__USERESSOURCE,
				 true,
				 false,
				 true,
				 null,
