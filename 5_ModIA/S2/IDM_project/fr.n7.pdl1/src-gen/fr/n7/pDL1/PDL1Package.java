...
public interface PDL1Package extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Useressources</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int WORK_DEFINITION__USERESSOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 1;
  ...
  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.RessourcesImpl <em>Ressources</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.RessourcesImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessources()
   * @generated
   */
  int RESSOURCES = 5;
   ...
   * @ordered
   */
  int RESSOURCES__NB_RESSOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int RESSOURCES__USERESSOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int RESSOURCES_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 3;

  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.UseRessourcesImpl <em>Use Ressources</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.UseRessourcesImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getUseRessources()
   * @generated
   */
  int USE_RESSOURCES = 6;
   ...
   * @ordered
   */
  int USE_RESSOURCES__QUANTITY = 0;
   ...
   * @ordered
   */
  int USE_RESSOURCES__RESSOURCES = 1;

  /**
   * The number of structural features of the '<em>Use Ressources</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int USE_RESSOURCES_FEATURE_COUNT = 2;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.WorkDefinition#getUseressources <em>Useressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Useressources</em>'.
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.Ressources <em>Ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Ressources</em>'.
   * @see fr.n7.pDL1.Ressources
   * @generated
   */
  EClass getRessources();

  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Ressources#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see fr.n7.pDL1.Ressources#getName()
   * @see #getRessources()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Ressources#getNb_ressources <em>Nb ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Nb ressources</em>'.
   * @see fr.n7.pDL1.Ressources#getNb_ressources()
   * @see #getRessources()
   * @generated
   */
  EAttribute getRessources_Nb_ressources();

  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.Ressources#getUseressources <em>Useressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Useressources</em>'.
   * @see fr.n7.pDL1.Ressources#getUseressources()
   * @see #getRessources()
   * @generated
   */
  EReference getRessources_Useressources();

  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.UseRessources <em>Use Ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Use Ressources</em>'.
   * @see fr.n7.pDL1.UseRessources
   * @generated
   */
  EClass getUseRessources();

  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.UseRessources#getQuantity <em>Quantity</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Quantity</em>'.
   * @see fr.n7.pDL1.UseRessources#getQuantity()
   * @see #getUseRessources()
   * @generated
   */
  EAttribute getUseRessources_Quantity();

  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.UseRessources#getRessources <em>Ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Ressources</em>'.
   * @see fr.n7.pDL1.UseRessources#getRessources()
   * @see #getUseRessources()
   * @generated
   */
  EReference getUseRessources_Ressources();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Useressources</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference WORK_DEFINITION__USERESSOURCES = eINSTANCE.getWorkDefinition_Useressources();
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.RessourcesImpl <em>Ressources</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.RessourcesImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessources()
     ...
     * @generated
     */
    EAttribute RESSOURCES__NB_RESSOURCES = eINSTANCE.getRessources_Nb_ressources();
     ...
     * @generated
     */
    EReference RESSOURCES__USERESSOURCES = eINSTANCE.getRessources_Useressources();

    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.UseRessourcesImpl <em>Use Ressources</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.UseRessourcesImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getUseRessources()
     * @generated
     */
    EClass USE_RESSOURCES = eINSTANCE.getUseRessources();
     ...
     * @generated
     */
    EAttribute USE_RESSOURCES__QUANTITY = eINSTANCE.getUseRessources_Quantity();
     ...
     * @generated
     */
    EReference USE_RESSOURCES__RESSOURCES = eINSTANCE.getUseRessources_Ressources();
