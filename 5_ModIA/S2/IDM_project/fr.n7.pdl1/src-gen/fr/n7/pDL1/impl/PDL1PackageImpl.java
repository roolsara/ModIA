...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
   ...
   * @generated
   */
  private EClass useRessourcesEClass = null;
   ...
   */
  @Override
  public EAttribute getRessources_Nb_ressources()
  {
   ...
   */
  @Override
  public EReference getRessources_Useressources()
  {
    return (EReference)ressourcesEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EClass getUseRessources()
  {
    return useRessourcesEClass;
  }
   ...
   */
  @Override
  public EAttribute getUseRessources_Quantity()
  {
    return (EAttribute)useRessourcesEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getUseRessources_Ressources()
  {
    return (EReference)useRessourcesEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(workDefinitionEClass, WORK_DEFINITION__USERESSOURCES);
    ...
    createEAttribute(ressourcesEClass, RESSOURCES__NB_RESSOURCES);
    createEReference(ressourcesEClass, RESSOURCES__USERESSOURCES);

    useRessourcesEClass = createEClass(USE_RESSOURCES);
    createEAttribute(useRessourcesEClass, USE_RESSOURCES__QUANTITY);
    createEReference(useRessourcesEClass, USE_RESSOURCES__RESSOURCES);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getWorkDefinition_Useressources(), this.getUseRessources(), null, "useressources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getRessources_Name(), ecorePackage.getEString(), "name", null, 0, 1, Ressources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRessources_Nb_ressources(), ecorePackage.getEInt(), "nb_ressources", null, 0, 1, Ressources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRessources_Useressources(), this.getUseRessources(), null, "useressources", null, 0, -1, Ressources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(useRessourcesEClass, UseRessources.class, "UseRessources", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getUseRessources_Quantity(), ecorePackage.getEInt(), "quantity", null, 0, 1, UseRessources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getUseRessources_Ressources(), this.getRessources(), null, "ressources", null, 0, 1, UseRessources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
