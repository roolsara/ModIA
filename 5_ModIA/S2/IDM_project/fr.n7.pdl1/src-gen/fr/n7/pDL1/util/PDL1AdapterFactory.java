...
public class PDL1AdapterFactory extends AdapterFactoryImpl
{
  ...
  protected PDL1Switch<Adapter> modelSwitch =
    new PDL1Switch<Adapter>()
    {
      ...
      @Override
      public Adapter caseUseRessources(UseRessources object)
      {
        return createUseRessourcesAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL1.Ressources <em>Ressources</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL1.UseRessources <em>Use Ressources</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createUseRessourcesAdapter()
  {
    return null;
  }
