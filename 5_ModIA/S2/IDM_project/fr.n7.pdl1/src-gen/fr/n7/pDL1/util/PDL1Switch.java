...
public class PDL1Switch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case PDL1Package.RESSOURCES:
      {
        ...
        if (result == null) result = caseProcessElement(ressources);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case PDL1Package.USE_RESSOURCES:
      {
        UseRessources useRessources = (UseRessources)theEObject;
        T result = caseUseRessources(useRessources);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Use Ressources</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Use Ressources</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseUseRessources(UseRessources object)
  {
    return null;
  }
