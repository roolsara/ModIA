...
public class PDL1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ProcessElementElements extends AbstractParserRuleElementFinder {
		...
		//ProcessElement :
		//    WorkDefinition | WorkSequence | Guidance | Ressources;
		@Override public ParserRule getRule() { return rule; }
	...
	public class WorkDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		private final Assignment cUseressourcesAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cUseressourcesUseRessourcesParserRuleCall_2_0 = (RuleCall)cUseressourcesAssignment_2.eContents().get(0);
		
		//WorkDefinition :
		//    'wd' name=ID
		//        (useressources+=UseRessources)*;
		@Override public ParserRule getRule() { return rule; }
		...
		//(useressources+=UseRessources)*
		public Assignment getUseressourcesAssignment_2() { return cUseressourcesAssignment_2; }
		
		//UseRessources
		public RuleCall getUseressourcesUseRessourcesParserRuleCall_2_0() { return cUseressourcesUseRessourcesParserRuleCall_2_0; }
	}
	public class WorkSequenceElements extends AbstractParserRuleElementFinder {
		...
		// // ajout de la référence d’utilisation de ressources
		//WorkSequence :
	...
	public class RessourcesElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cNb_ressourcesAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cNb_ressourcesINTTerminalRuleCall_3_0 = (RuleCall)cNb_ressourcesAssignment_3.eContents().get(0);
		private final Assignment cUseressourcesAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cUseressourcesUseRessourcesParserRuleCall_4_0 = (RuleCall)cUseressourcesAssignment_4.eContents().get(0);
		
		//Ressources:
		//    'resource' name=ID
		//        'amount' nb_ressources=INT
		//        (useressources+=UseRessources)*;
		@Override public ParserRule getRule() { return rule; }
		...
		//nb_ressources=INT
		public Assignment getNb_ressourcesAssignment_3() { return cNb_ressourcesAssignment_3; }
		
		//INT
		public RuleCall getNb_ressourcesINTTerminalRuleCall_3_0() { return cNb_ressourcesINTTerminalRuleCall_3_0; }
		
		//(useressources+=UseRessources)*
		public Assignment getUseressourcesAssignment_4() { return cUseressourcesAssignment_4; }
		
		//UseRessources
		public RuleCall getUseressourcesUseRessourcesParserRuleCall_4_0() { return cUseressourcesUseRessourcesParserRuleCall_4_0; }
	}
	public class UseRessourcesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.PDL1.UseRessources");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cRessourcesAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final CrossReference cRessourcesRessourcesCrossReference_3_0 = (CrossReference)cRessourcesAssignment_3.eContents().get(0);
		private final RuleCall cRessourcesRessourcesIDTerminalRuleCall_3_0_1 = (RuleCall)cRessourcesRessourcesCrossReference_3_0.eContents().get(1);
		
		//UseRessources:
		//    'use' quantity=INT
		//        'of' ressources=[Ressources];
		@Override public ParserRule getRule() { return rule; }
		...
		public Assignment getRessourcesAssignment_3() { return cRessourcesAssignment_3; }
		
		//[Ressources]
		public CrossReference getRessourcesRessourcesCrossReference_3_0() { return cRessourcesRessourcesCrossReference_3_0; }
		
		//ID
		public RuleCall getRessourcesRessourcesIDTerminalRuleCall_3_0_1() { return cRessourcesRessourcesIDTerminalRuleCall_3_0_1; }
	}
	...
	private final UseRessourcesElements pUseRessources;
	...
	public PDL1GrammarAccess(GrammarProvider grammarProvider,
		...
		this.pUseRessources = new UseRessourcesElements();
	}
	...
	//    'use' quantity=INT
	//        'of' ressources=[Ressources];
	public UseRessourcesElements getUseRessourcesAccess() {
		return pUseRessources;
	}
	
	public ParserRule getUseRessourcesRule() {
		return getUseRessourcesAccess().getRule();
	}
