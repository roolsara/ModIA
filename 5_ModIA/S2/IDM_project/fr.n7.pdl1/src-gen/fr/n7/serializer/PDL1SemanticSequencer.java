...
public class PDL1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PDL1Package.eINSTANCE)
			...
			case PDL1Package.PROCESS:
				...
				return; 
			case PDL1Package.RESSOURCES:
				sequence_Ressources(context, (Ressources) semanticObject); 
				return; 
			case PDL1Package.USE_RESSOURCES:
				sequence_UseRessources(context, (UseRessources) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     ProcessElement returns Ressources
	 *     Ressources returns Ressources
	 *
	 * Constraint:
	 *     (name=ID nb_ressources=INT useressources+=UseRessources*)
	 * </pre>
	 */
	 ...
	 * <pre>
	 * Contexts:
	 *     UseRessources returns UseRessources
	 *
	 * Constraint:
	 *     (quantity=INT ressources=[Ressources|ID])
	 * </pre>
	 */
	protected void sequence_UseRessources(ISerializationContext context, UseRessources semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.USE_RESSOURCES__QUANTITY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.USE_RESSOURCES__QUANTITY));
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.USE_RESSOURCES__RESSOURCES) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.USE_RESSOURCES__RESSOURCES));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getUseRessourcesAccess().getQuantityINTTerminalRuleCall_1_0(), semanticObject.getQuantity());
		feeder.accept(grammarAccess.getUseRessourcesAccess().getRessourcesRessourcesIDTerminalRuleCall_3_0_1(), semanticObject.eGet(PDL1Package.Literals.USE_RESSOURCES__RESSOURCES, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID useressources+=UseRessources*)
	 * </pre>
	 */
