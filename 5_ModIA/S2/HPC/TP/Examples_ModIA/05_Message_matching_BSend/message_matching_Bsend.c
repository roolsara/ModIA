...
int main(int argc, char* argv[]) {
    ...
    switch(my_rank)
    {
        case SENDER:
        {
            ...
            int buffer_sent;
            buffer_sent = 12345;
            printf("[MPI process %d] I send value 1: %d.\n", my_rank, buffer_sent);
            MPI_Bsend(&buffer_sent, 1, MPI_INT, RECEIVER, 0, MPI_COMM_WORLD);

            buffer_sent = 67890;
            printf("[MPI process %d] I send value 2: %d.\n", my_rank, buffer_sent);
            MPI_Bsend(&buffer_sent, 1, MPI_INT, RECEIVER, 1, MPI_COMM_WORLD);
        ...
        case RECEIVER:
        {
            ...
            printf("[MPI process %d] I received value 2: %d.\n", my_rank, received);
            break;
        }
    }
